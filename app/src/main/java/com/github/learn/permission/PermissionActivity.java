    ...
    public void onClick(View v, int position) {
        ...
        if (status == PermissionStatus.GRANTED) {
            ...
            //ListenerPermission.from(this)
                    ...
                    //.setPermissions(mRequestPermission.permissionName, mAdapter.getItem(position + 1).permissionName)
                    ...
                    //.check();
            //ListenerPermission.requestPermissions(this, new String[]{mRequestPermission.permissionName}, this);
            //ShadowPermissionActivity.setPermissionListener(this);
            //startActivity(new Intent(this, ShadowPermissionActivity.class));
        }
    }
