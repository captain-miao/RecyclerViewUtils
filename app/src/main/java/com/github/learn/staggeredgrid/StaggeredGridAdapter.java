 ...
 * @since 16/4/23
 */
public class StaggeredGridAdapter extends BaseWrapperRecyclerAdapter<TextModel> implements OnRecyclerItemClickListener {

    public StaggeredGridAdapter(List<TextModel> items) {
        appendToList(items);
    }
